    ...
    return (
        <div className="flex justify-between items-center z-20">
            ...
            <div className="flex gap-2">
                {isSavingPost || isDeletingSaved ? <Loader /> : <img src={isSaved ? "/assets/icons/saved.svg" : "/assets/icons/save.svg"} alt="like" width={25} height={25} onClick={handleSavedPost} className="cursor-pointer" />}
            </div>
        </div>
    )
}
